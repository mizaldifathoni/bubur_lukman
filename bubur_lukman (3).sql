...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Apr 2020 pada 10.31
...
(2, 'logo', 'assets/picture/base/logo_Bubur_Lukmanz_5e8edb4882f8c.png'),
...
(5, 'foto_toko', 'assets/picture/base/foto_Bubur_Lukmanz_5e8edb4884563.jpg'),
...
(7, 'nomor_hp', '+6282279650575'),
(8, 'email', 'buburlukman@gmail.com'),
(9, 'lokasi', 'Jl. Pulau Legundi No.202'),
(10, 'waktu_buka', 'Senin-Minggu : 06.30 WIB - 21.00 WIB'),
...
--
ALTER TABLE `menu_toko`
  MODIFY `id_menu_toko` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
